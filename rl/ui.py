...
class UI:
    def __init__(self, board_size: int):
        ...
        self.hex_radius = 20
        self.x_offset, self.y_offset = 60, 100
        self.text_offset = 45
    ...
    def draw_hexagon(self, surface: object, color: tuple, position: tuple, node: int):
        ...
        # Outline
        self.hex_lookup[node] = [(x + (self.hex_radius + offset) * math.cos(math.radians(90) + 2 * math.pi * _ / n),
                                  y + (self.hex_radius + offset) * math.sin(math.radians(90) + 2 * math.pi * _ / n))
                                 for _ in range(n)]
        ...
        gfxdraw.filled_polygon(surface,
                               [(x + self.hex_radius * math.cos(math.radians(90) + 2 * math.pi * _ / n),
                                 y + self.hex_radius * math.sin(math.radians(90) + 2 * math.pi * _ / n))
                                for _ in range(n)],
                               self.color[node])
    ...
    def draw_text(self):
        ...
        for _ in range(self.board_size):
            ...
            text_rect.center = (self.x_offset + (2 * self.hex_radius) * _, self.y_offset - self.text_offset)
